...
/* Given the position of previous leftmost set bit in n (or an upper
   ...
   set bit in n  */
    int getNextLeftmostBit (int n, int m) {
        int temp = 1 << m;
        while (n  < temp)
        {
            temp = temp >> 1;
...
// Returns count of set bits present in all numbers from 1 to n
    ...
    public static void main(String[] args) {
        int n = 9;
        CountBits1ToN c = new CountBits1ToN();
        System.out.println("Total set bit count is " +  c.countSetBits(n));
    }
}
